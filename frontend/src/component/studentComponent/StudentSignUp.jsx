                ...
                <div className="bg-gray-800 flex p-8 rounded-xl my-5 border-2 border-gray-700" >
                    <div className="max-w-sm mx-auto">
                        ...
                        <div className="flex justify-center py-5 " >
                            <div>
                                <div className="flex justify-center" >
                                    <h1 className="font-semibold text-white text-xl" >Student SignUp</h1>
                                </div>
                                <div>
                                    <h1 className="text-sm flex gap-1 text-gray-300" >Already have an account? <Link to='/student-login' className="text-blue-500 underline cursor-pointer" > Login</Link></h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="py-2" >
                            ...
                            <div className="py-5">
                                ...
                                <input type="number" className="bg-gray-700 border text-gray-300 border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter contact number..." required />
                            </div>
                        ...
                        <div className="mb-5" >
                            <span className="opacity-50 text-gray-300">Admission : </span>
                            <div className="grid grid-cols-12 gap-2">
                                ...
                                <div className="col-span-6">
                                    {/* <span className="text-gray-300" >AdmissionDate :</span> */}
                                    <input type="date"
                                        className="bg-gray-700 text-gray-300 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required />
                                </div>
