                                ...
                                <div className=" bg-gray-800 p-8 rounded-2xl my-5 border-2 border-gray-700" >
                                    ...
                                    <div className="max-w-sm mx-auto relative">
                                        ...
                                        <div className="flex mb-5  justify-center" >
                                            <h1 className="text-[12px] flex gap-1 text-white" >Don't have any account? <Link to='/admin-signup' className="text-blue-500 underline" > SignUp now</Link></h1>
                                        </div>
                ...
                <div className="bg-gray-400 flex p-5 rounded-md mt-20 " >
                    ...
                    <div className="max-w-sm mx-auto p-10">
                        ...
                        <div className="flex mb-5 px-0 py-3" >
                            <h1 className="text-[12px] flex gap-1" >Don't have any account? <Link to='/admin-signup' className="text-blue-500 underline" > SignUp now</Link></h1>
                        </div>
                        <div className="grid grid-cols-12 gap-4" >
                            <div className="mb-1 col-span-12">
                            ...
                            <div className="col-span-12" >
                                <div className="flex justify-end" >
                                    <Link to={""} className="hover:text-blue-500 text-sm hover:underline" >
                                        Forgot Password?
                                    </Link>
                                </div>
                            </div>
