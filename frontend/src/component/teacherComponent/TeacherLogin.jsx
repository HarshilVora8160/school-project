    ...
    return (
        <div>
                                ...
                                <div className=" bg-gray-800 p-8 my-5 rounded-2xl border-2 border-gray-700" >
                                    ...
                                    <div className="max-w-sm mx-auto relative">
                                        <div className="flex text-xl justify-center" >
                                            <h1 className="text-xl font-semibold text-white" >Teacher Login</h1>
                                        </div>
                                        <div className="flex mb-5 justify-center" >
                                            <h1 className="text-[12px] flex gap-1 text-white" >Don't have any account? <Link to='/teacher-signup' className="text-blue-500 underline" > SignUp now</Link></h1>
                                        </div>
            ...
            <div className="flex justify-center items-center mb-10" >
                <div className="bg-gray-400 flex p-5 rounded-md mt-20 " >
                    <div className="flex pr-5" >
                        <img className="h-150 rounded-xl" src="https://img.freepik.com/free-photo/front-view-stacked-books-graduation-cap-diploma-education-day_23-2149241011.jpg" />
                    </div>
                    <div className="max-w-sm mx-auto p-10">
                        <div className="flex text-xl" >
                            <h1 className="text-3xl font-semibold" >Teacher Login</h1>
                        </div>
                        <div className="flex mb-5 px-0 py-3" >
                            <h1 className="text-[12px] flex gap-1" >Don't have any account? <Link to='/teacher-signup' className="text-blue-500 underline" > SignUp now</Link></h1>
                        </div>
                        <div className="grid grid-cols-12 gap-4" >
                            <div className="mb-1 col-span-12">
                                <input type="email" className="bg-gray-200 border border-gray-300 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter email..." required />
                            </div>
                            <div className="col-span-12">
                                <input type="password" className="bg-gray-200 border border-gray-300 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter password..." required />
                            </div>
                            <div className="col-span-12">
                                <div className="flex justify-end">
                                    <Link href="#" className="text-sm hover:text-blue-500 hover:underline">
                                        Forgot Password?
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="col-span-6 mb-5" >
                                <input type="date" className="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="type your age.." required />
                            </div>
                        </div>

                        <div className="flex items-center mb-10">
                            <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                            <label htmlFor="default-checkbox" className="flex ms-2 gap-1 text-[12px] hover:cursor-pointer text-gray-900 ">I agree to the<p className="text-blue-500 underline text-[12px]" > Terms & Conditions</p></label>
                        </div>
                        ...
                        <div className="flex items-center w-full py-3">
                            <div className="flex-grow border-t border-gray-500"></div>
                            <span className="px-4 text-gray-500 text-[10px]">Or login with</span>
                            <div className="flex-grow border-t border-gray-500"></div>
                        </div>
                        <div className="grid grid-cols-12 gap-2" >
                            <div className="col-span-6 flex justify-center" >
                                <button className="border rounded-sm border-gray-800 w-full p-1" >
                                    <p className="text-[14px] flex justify-center items-center gap-1" ><GoogleIcon className="text-blue-500 text-3xl" /> Google</p>
                                </button>
                            </div>
                            <div className="col-span-6 flex justify-center" >
                                <button className="border rounded-sm border-gray-800 w-full" >
                                    <p className="text-[14px] flex justify-center items-center gap-1" ><AppleIcon className="text-blue-500 text-3xl" /> Apple</p>
                                </button>
                            </div>
                        </div>
                    </div>
